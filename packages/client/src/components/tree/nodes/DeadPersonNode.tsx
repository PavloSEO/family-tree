...
export function DeadPersonNode(props: NodeProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center">
        {!src || broken ? (
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[var(--md-sys-color-surface-container-high)] grayscale">
